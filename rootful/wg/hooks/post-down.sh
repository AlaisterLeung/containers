...
iptables -D FORWARD -s 192.168.0.0/24 -d 10.8.0.0/24 -m state --state RELATED,ESTABLISHED -j ACCEPT
...
ip route del 192.168.0.0/24 via 10.89.1.1 dev eth0 table 200
